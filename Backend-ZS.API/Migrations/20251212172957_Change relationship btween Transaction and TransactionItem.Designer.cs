...
namespace Backend_ZS.API.Migrations
{
    ...
    [Migration("20251212172957_Change relationship btween Transaction and TransactionItem")]
    partial class ChangerelationshipbtweenTransactionandTransactionItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend_ZS.API.Models.Domain.Transaction", b =>
                {
                    ...
                    b.HasOne("Backend_ZS.API.Models.Domain.Payment", "Payment")
                        .WithOne()
                        .HasForeignKey("Backend_ZS.API.Models.Domain.Transaction", "PaymentId")
                        .OnDelete(DeleteBehavior.Restrict);
